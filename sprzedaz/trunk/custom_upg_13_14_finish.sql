...
go
---------------------------------------------------------------------------------
-- from C:\sprzedaz\sql\upgrade_db13_to_db13b.sql
...
---------------------------------------------------------------------------------
-- from C:\sprzedaz\sql\VAT_UE_default.sql
-- ustawienie wartoœci pocz¹tkowej dla VAT UE (DB13)
update n5klient set kli_cVATUE = '0'
go

---------------------------------------------------------------------------------
-- C:\sprzedaz\sql\uprawnienia_kreator_wyciagow_bankowych.sql
...
exec n2001_setprofile_value 1000, '14'
go

n2001_makegrants 'navo2002user'
go

raiserror('completed upgrade to DB14 (2018.07.11.00)',0,1)
go
---------------------------------------------------------------------------------
---------------------------------------------------------------------------------
