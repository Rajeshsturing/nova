...
#include "stdafx.h"
#include "..\include\CmdTargetPlus.h"
...
/*
		...
		TO JEST DOBRY KOD ALE NIE UZYWANY
...
BEGIN_MESSAGE_MAP(CCmdTargetPlus, CCmdTargetInterface)
	//{{AFX_MSG_MAP(CCmdTargetPlus)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

BEGIN_DISPATCH_MAP(CCmdTargetPlus, CCmdTargetInterface)
...
BEGIN_INTERFACE_MAP(CCmdTargetPlus, CCmdTargetInterface)
...
{
	METHOD_PROLOGUE_EX_(CCmdTargetPlus, ProvideClassInfo)
	TRACE0("GetGUID in provideclassinfo\n");
