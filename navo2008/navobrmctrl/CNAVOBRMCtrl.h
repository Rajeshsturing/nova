...
// CNAVOBRMCtrl.h : Declaration of the CNAVOBRMCtrl ActiveX Control class.


// CNAVOBRMCtrl : See CNAVOBRMCtrl.cpp for implementation.
...
// Message maps
	...
	afx_msg BSTR GetRootDirAUTO();
	afx_msg void SetRootDirAUTO(LPCTSTR lpszNewValue);
